...
if (!is_file($wampConfFile))
    die ('Unable to open WampServer\'s config file, please change path in indexOld.php file');
...
//header('Location: /aviatechno/indexOld.php');
//exit();        
...
#head {
	...
	text-indent: -500em;
	height: 125px;
	background: url(indexOld.php?img=gifLogo) 0 0 no-repeat;
}
.utility {
	position: absolute;
	right: 4em;
...
ul.aliases a, ul.projects a, ul.tools a {
	padding-left: 22px;
	background: url(indexOld.php?img=pngFolder) 0 100% no-repeat;
}
ul.tools a {
	background: url(indexOld.php?img=pngWrench) 0 100% no-repeat;
}
ul.aliases a {
	background: url(indexOld.php?img=pngFolderGo) 0 100% no-repeat;
}
...
dd ul li {
	...
	margin: 0;
	padding: 0 0 0 20px;
	background: url(indexOld.php?img=pngPlugin) 2px 50% no-repeat;
	line-height: 1.6;
}
a {
	color: #024378;
...
.right {float:right;}
	...
	<link rel="shortcut icon" href="indexOld.php?img=favicon" type="image/ico" />
</head>
